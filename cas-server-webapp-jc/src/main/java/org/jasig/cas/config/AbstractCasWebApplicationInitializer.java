...
import org.jasig.cas.config.rootcontext.RootConfig;
import org.jasig.cas.config.servletcontext.ServletConfig;
...
public abstract class AbstractCasWebApplicationInitializer
    ...
    private static final Logger log = LoggerFactory.getLogger(AbstractCasWebApplicationInitializer.class);

    private static String CAS_SERVLET_NAME = "cas-servlet";
    private static String CAS_HOME = "/opt/cas2";

    public static String getCasServletName() {
        return CAS_SERVLET_NAME;
    }

    public static void setCasServletName(String casServletName) {
        CAS_SERVLET_NAME = casServletName;
    }
    ...
    /**
     * If CAS Home Directory not exist, make directory, necessary sub-directory
     * and copy resources.
     *
     * Directory Structure CAS_HOME/logs : log directory CAS_HOME/i18n : message
     * sources directory CAS_HOME/conf : cas configuration directory
     *
     * @throws IOException
     */
    private void initCasHomeDir() throws IOException {
        ...
        if (!ObjectUtils.isEmpty(casHome))
            CAS_HOME = casHome;
